...
class Settings(BaseSettings):
    ...
    # CORS Settings
    CORS_ORIGINS: str = "http://localhost:5173,http://127.0.0.1:5173,http://localhost:5174,https://monitoring-app-frontend.geminikil00.workers.dev,https://monitoring.joclass.com"
